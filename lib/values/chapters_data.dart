...
class Chapters {
  static const Chapter cap01 = Chapter(
    ...
    "A vida começou como ela sempre começa: \n" +
        ...
        "- O nome do lugar para onde vamos? \n" +
        "- Seu nome? \n" +
        "- Meu nome?",
    "Meu nome? Eu não lembro o meu nome. Eu preciso lembrar, essa falta me causa dor.",
    "format",
  );
  ...
  // Capítulo 03
  static const Chapter cap03 = Chapter(
    3,
    Icons.ac_unit,
    "Segredos",
  ...
  // Capítulo 04
  static const Chapter cap04 = Chapter(
    4,
    Icons.ac_unit,
    "Criação",
    "Foi por causa dos segredos, e de como lidar com eles, que criamos o que voltaria a ser a origem da vida.\n\n" +
  ...
  // Capítulo 05
  static const Chapter cap05 = Chapter(
    5,
    Icons.ac_unit,
    "Guerra",
    "A guerra me corrompeu.\n\n" +
        "Lembrar do que não lembro é doloroso.\n\n" +
