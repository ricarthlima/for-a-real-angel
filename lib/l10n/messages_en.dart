...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "buyFARA" : MessageLookupByLibrary.simpleMessage("Buy FARA!"),
    "buyFARAText" : MessageLookupByLibrary.simpleMessage("Did you reach level 10? Buy the full version of FARA to have access to the continuation of this story. \nBenefits: \n\n- No ads. \n- 100 DPs free \n- Free tips for approaching (Andrew warns you if you get close). \n- New levels arrive weekly. \n- Real-time correction of errors and bugs. \n- Participation in the world ranking."),
    ...
    "getFiveDP" : MessageLookupByLibrary.simpleMessage("Get 5 DPs for free!"),
    ...
    "noAdsAvalible" : MessageLookupByLibrary.simpleMessage("You have no ads available yet."),
    ...
    "putUsername" : MessageLookupByLibrary.simpleMessage("Enter your nickname"),
    ...
    "starterHintInfos" : MessageLookupByLibrary.simpleMessage("You are dealing with secret, confidential and encrypted files and information. Nothing is as it seems, use all the tools to manipulate the investigated files."),
    "starterHintSounds" : MessageLookupByLibrary.simpleMessage("Sound are important in FARA. Try to play with headphones."),
    "starterHintTools" : MessageLookupByLibrary.simpleMessage("Use all possible information to solve the puzzles. Do not hesitate to research and learn about any new theme."),
    "starterHints" : MessageLookupByLibrary.simpleMessage("Check this hints out!"),
