...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "buyFARA" : MessageLookupByLibrary.simpleMessage("Compre FARA!"),
    "buyFARAText" : MessageLookupByLibrary.simpleMessage("Chegou no nível 10? Compre a versão completa de FARA para ter acesso a continuação dessa história.\nBenefícios:\n\n- Sem anúncios. \n- Ganhe 100 DPs de graça! \n- Dicas gratúitas por aproximação (Andrew te avisa se você chegar perto).\n- Novos níveis chegam semanalmente.\n- Correção em tempo real de erros e bugs.\n- Participação no ranking mundial."),
    "buyHint" : MessageLookupByLibrary.simpleMessage("Comprar dica"),
    "continuar" : MessageLookupByLibrary.simpleMessage("Continuar."),
    "dataPoints" : MessageLookupByLibrary.simpleMessage("Pontos de Dados"),
    "dataPointsExplanation" : MessageLookupByLibrary.simpleMessage("Data Points são setores recuperados após uma desfragmentação. Você pode usar DPs para facilitar o processo de restauração dos dados. Eles também contam para seu ranking."),
    "documents" : MessageLookupByLibrary.simpleMessage("Documentos"),
    "episode" : MessageLookupByLibrary.simpleMessage("Episódio"),
    "error" : MessageLookupByLibrary.simpleMessage("Erro"),
    "getFiveDP" : MessageLookupByLibrary.simpleMessage("Ganhe 5 DP de graça!"),
    ...
    "noAdsAvalible" : MessageLookupByLibrary.simpleMessage("Você ainda não possui anúncios disponíveis."),
    "noDataPoints" : MessageLookupByLibrary.simpleMessage("Eu não tenho Pontos de Dados suficientes para te ajudar."),
    "noneHint" : MessageLookupByLibrary.simpleMessage("Nenhuma dica desbloqueada."),
    "notRecognizedCommand" : MessageLookupByLibrary.simpleMessage("não foi reconhecido como um comando do terminal."),
    "notSignUp" : MessageLookupByLibrary.simpleMessage("Você ainda não se cadastrou."),
    "okay" : MessageLookupByLibrary.simpleMessage("OK"),
    "purchase" : MessageLookupByLibrary.simpleMessage("Comprar!"),
    "putUsername" : MessageLookupByLibrary.simpleMessage("Insira seu nickname"),
    "recycleBin" : MessageLookupByLibrary.simpleMessage("Lixeira\n"),
    "remebering" : MessageLookupByLibrary.simpleMessage("Estou me lembrando"),
    "restore" : MessageLookupByLibrary.simpleMessage("Restaurar"),
    "seeHints" : MessageLookupByLibrary.simpleMessage("Ver dicas"),
    ...
    "starterHintInfos" : MessageLookupByLibrary.simpleMessage("Você está lidando com arquivos e informações secretas, sigilosas e criptografadas. Nada é o que parece, use todas as ferramentas para manipular os arquivos investigados."),
    "starterHintSounds" : MessageLookupByLibrary.simpleMessage("Os sons são importantes em FARA. Se possível, jogue com fones de ouvido."),
    "starterHintTools" : MessageLookupByLibrary.simpleMessage("Use todas as informações possíveis para resolver os enigmas. Não hesite em pesquisar e aprender sobre algum assunto novo."),
    "starterHints" : MessageLookupByLibrary.simpleMessage("Dicas sobre F(or) A Real Angel"),
